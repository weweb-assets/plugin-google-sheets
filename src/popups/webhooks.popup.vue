<template>
    <div class="ww-popup-spreadsheet-automations">
        <div class="spreadsheet-automations__row" v-for="(sheet, index) in settings.privateData.sheets" :key="index">
...
.ww-popup-spreadsheet-automations {
    position: relative;
    display: flex;
